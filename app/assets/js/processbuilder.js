...
const LaunchPolicy             = require('./launchpolicy')
const MinecraftDefaults        = require('./minecraftdefaults')
...
class ProcessBuilder {
    ...
    build(){
        ...
        if(MinecraftDefaults.ensureInitialOptions(this.gameDir)) {
    ...
    _processAutoConnectArg(args){
        args.push(...LaunchPolicy.createAutoConnectArguments({
            enabled: ConfigManager.getAutoConnect(),
            serverAutoconnect: this.server.rawServer.autoconnect,
            minecraftVersion: this.server.rawServer.minecraftVersion,
