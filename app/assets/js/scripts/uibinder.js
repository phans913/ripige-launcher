...
const LAUNCHER_BACKGROUND_IMAGE = 'assets/images/backgrounds/ripige.png'
...
async function showMainUI(data){
    ...
    setTimeout(() => {
        try {
            ...
            // 로딩이 끝난 뒤에도 같은 파노라마 이미지를 유지해서 화면 전환 시 배경이 바뀌지 않게 한다.
            document.body.style.backgroundImage = `url('${LAUNCHER_BACKGROUND_IMAGE}')`
            $('#main').show()
            ...
            console.error('[showMainUI Error]', e)
        }
    }, 750)
    ...
    setTimeout(() => {
        ...
        console.log('loginOptions innerHTML:', document.getElementById('loginOptionsContainer').innerHTML)
    }, 5000)
}
...
function onDistroRefresh(data){
    ...
    setTimeout(() => {
        console.log('=== DOM DUMP ===')
        console.log('currentView:', currentView)
        console.log('welcome display:', document.getElementById('welcomeContainer').style.display)
        console.log('loginOptions display:', document.getElementById('loginOptionsContainer').style.display)
        console.log('loading display:', document.getElementById('loadingContainer').style.display)
    }, 5000)
}
